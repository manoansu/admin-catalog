...
import pt.amane.domain.UnitTest;
...
public class GenreTest extends UnitTest {
    ...
    public void givenValidParams_whenCallNewGenre_shouldInstantiateAGenre() {
        ...
        Assertions.assertNotNull(getGenreUpdatedAt(actualGenre));
    ...
    public void givenAnInactiveGenre_whenCallActivate_shouldReceiveOK() {
        ...
        Assertions.assertEquals(expectedCategories, actualGenre.getCategories().size());
        Assertions.assertEquals(actualCreatedAt, actualGenre.getCreatedAt());
        Assertions.assertEquals(actualUpdatedAt, getGenreUpdatedAt(actualGenre));
        Assertions.assertNotNull(getGenreUpdatedAt(actualGenre));
        Assertions.assertNull(actualGenre.getDeletedAt());
    }
    ...
    public void givenAValidInactiveGenre_whenCallUpdateWithActivate_shouldReceiveGenreUpdated() {
        ...
        Assertions.assertEquals(actualCreatedAt, actualGenre.getCreatedAt());
        Assertions.assertTrue(actualUpdatedAt.isBefore(getGenreUpdatedAt(actualGenre)));
        Assertions.assertNull(actualGenre.getDeletedAt());
    }
...
//        final var actualUpdatedAt = getGenreUpdatedAt(actualGenre);
    ...
    private static Instant getGenreUpdatedAt(Genre actualGenre) {
        return actualGenre.getUpdatedAt();
    }
}
