...
public class CategoryAPITest {
  ...
  @Test
  void givenAValidCommand_whenCallCreatedCategory_shouldReturnCategoryId() throws Exception {
...
//        .with(ApiTest.CATEGORIES_JWT)
  ...
  public void givenAValidId_whenCallsGetCategory_shouldReturnCategory() throws Exception {
    ...
    final var aCategory =
        getNewCategory(expectedName, expectedDescription, expectedIsActive);
...
//        .with(ApiTest.CATEGORIES_JWT)
  ...
  public void givenValidParams_whenCallsListCategories_shouldReturnCategories() throws Exception {
    // given
    final var aCategory = getNewCategory("Movies", null, true);
...
//        .with(ApiTest.CATEGORIES_JWT)
  ...
  private static Category getNewCategory(final String aName, final String aDescription, final boolean isActive) {
